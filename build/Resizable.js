...
var Resizable = function (_React$Component) {
  ...
  Resizable.prototype.resizeHandler = function resizeHandler(handlerName, handlerAction) {
    var _this2 = this;
    ...
    return function (e, _ref) {
      ...
      _this2.setState(newState, function () {
        _this2.props[handlerName] && _this2.props[handlerName](e, { node: node, size: { width: width, height: height, deltaX: posX, deltaY: posY } });
      });
    };
  };
  ...
  Resizable.prototype.render = function render() {
    ...
    return (0, _cloneElement2.default)(p.children, _extends({}, p, {
      ...
      children: [p.children.props.children, _react2.default.createElement(
        ...
        _react2.default.createElement('span', { className: 'react-resizable-handle nw-resize' })
        ...
        _react2.default.createElement('span', { className: 'react-resizable-handle ne-resize' })
      ), _react2.default.createElement(
        _reactDraggable.DraggableCore,
        _extends({}, p.draggableOpts, {
          ref: 'draggable',
        ...
        _react2.default.createElement('span', { className: 'react-resizable-handle se-resize' })
      ), _react2.default.createElement(
        _reactDraggable.DraggableCore,
        _extends({}, p.draggableOpts, {
          ref: 'draggable',
        ...
        _react2.default.createElement('span', { className: 'react-resizable-handle sw-resize' })
      )]
    }));
  };
